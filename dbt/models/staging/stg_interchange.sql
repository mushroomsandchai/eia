...
with renamed as (
    select
        ...
        cast(fromba_name as string) as provider,
        upper(cast(fromba as string)) as provider_id,
        cast(toba_name as string) as recipient,
        upper(cast(toba as string)) as recipient_id,
    ...
    where 1 = 1
        ...
        and fromba is not null
        and toba is not null
